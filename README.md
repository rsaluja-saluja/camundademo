...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/com/camunda/camundademo/ProcessTest.java) in your IDE or using:
...
<!-- Tweet
New @Camunda example: Camunda BPM Process Application - A Process Application for [Camunda BPM](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/camundademo
-->
